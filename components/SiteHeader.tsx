...
export default function SiteHeader(){
 ...
 if(insurance)return <header className="header insuranceTopHeader"><div className="wrap insuranceNav">
  <Link href="/태아보험" className="insuranceLogo" aria-label="올바른 보험 홈" style={{display:'flex',alignItems:'center',flexShrink:0}}><img src="/images/insurance/올바른보험로고.webp" alt="올바른 보험" style={{display:'block',width:'clamp(150px,18vw,230px)',height:'auto',maxHeight:'58px',objectFit:'contain'}} /></Link>
