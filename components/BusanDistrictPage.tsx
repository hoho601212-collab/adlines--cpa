...
export default function BusanDistrictPage({district}:{district:BusanDistrict}){
 ...
 const schema={"@context":"https://schema.org","@type":"WebPage",name:`${keyword} 상담 전 가이드`,description:district.intro,url:`${site.baseUrl}/태아보험/부산태아보험/${district.slug}`,dateModified:site.contentReviewedAt,about:['태아보험','부산 출산지원',`${district.name} 출산·육아 지원`]};
