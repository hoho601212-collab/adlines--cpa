...
export default function BusanDistrictPage({district:rawDistrict}:{district:BusanDistrict}){
 ...
 const webPageSchema={"@context":"https://schema.org","@type":"WebPage",name:`${keyword} 상담 전 가이드`,description:district.intro,url:canonical,dateModified:site.contentReviewedAt,about:['태아보험','부산 출산지원',`${district.name} 출산·육아 지원`],publisher:{"@type":"Organization",name:site.insuranceName,url:site.baseUrl}};
