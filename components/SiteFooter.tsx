...
export function InsuranceFooter(){
 return <footer className="footer"><div className="wrap">
  <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(280px,1fr))',gap:'24px',alignItems:'start',marginBottom:'18px'}}>
   <div>
    <a href="/" className="insuranceFooterLogo" aria-label="올바른 보험 홈" style={{display:'inline-flex',alignItems:'center',marginBottom:'12px'}}><img src="/images/insurance/olbareun-insurance-logo.webp" alt="올바른 보험" width="220" height="60" style={{display:'block',width:'clamp(165px,17vw,220px)',height:'auto',maxHeight:'60px',objectFit:'contain',objectPosition:'left center'}} /></a>
   ...
   <div className="insuranceBusinessInfo" style={{padding:'16px 18px',border:'1px solid rgba(148,163,184,.22)',borderRadius:'14px',lineHeight:1.8}}>
    <b style={{display:'block',marginBottom:'6px'}}>보험 분석 비교 플랫폼 [ 올바른 ]</b>
    <p style={{margin:'0'}}>상호: 올바른 &nbsp; 대표자: 박자영</p>
    <p style={{margin:'0'}}>사업자 번호: 808-66-00808</p>
    <p style={{margin:'0'}}>Tel. 010-4780-1200 &nbsp; Fax. 0508-956-6109</p>
    <p style={{margin:'8px 0 0',fontSize:'12px',opacity:.72}}>© {new Date().getFullYear()} 올바른. All rights reserved.</p>
   </div>
  </div>
