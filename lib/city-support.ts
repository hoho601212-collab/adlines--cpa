...
const CITY_SUPPORT:Record<string,RegionalSupportItem[]>={
  ...
  남양주태아보험:[
    ...
    {title:'남양주 장애인가정 출산지원금',summary:'남양주시는 등록장애인 가정의 출산 부담을 줄이기 위한 별도 지원을 운영합니다.',benefit:'심한 장애 150만원 · 심하지 않은 장애 100만원 · 쌍생아는 영아 1명당 50% 가산',eligibility:'신생아 출생일 기준 부 또는 모가 남양주시에 주민등록을 두고 거주하는 등록장애인',apply:'관할 주민센터 복지팀 신청',sourceName:'남양주시청 장애인복지 특수시책',sourceUrl:'https://www.nyj.go.kr/www/contents.do?key=2898',verifiedAt:'2026-09-08'}
  ],
  안양태아보험:[
